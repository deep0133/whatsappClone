...
export default function FirstRightPage() {
  return (
    <div className="z-50 flex h-[100%] w-[100%] flex-col items-center rounded-r-md bg-[#f8f8f8] pt-20 lg:h-[91vh]">
      <span
      ...
      <div className="my-8 block text-slate-500">
        <div className="flex items-center justify-center space-x-4">
          <h1 className="text-black-800 text-4xl font-light">WhatsApp Web</h1>

          <b className="text relative top-1 rounded-3xl bg-[#9f9f9f] py-1 px-2 text-[10px] font-bold">
            NEW
          </b>
        </div>
        ...
        <div className="my-3">
          <div className="flex items-center justify-center">
            <span className="_33d9M">
              <span data-testid="laptop" data-icon="laptop" className="">
                <svg viewBox="0 0 21 18" width="21" height="18" className="">
                  <path
                    fill="currentColor"
      ...
      <div className="flex items-center justify-center space-x-2 text-slate-500">
        <span data-testid="lock-small" data-icon="lock-small" className="">
          <svg width="10" height="12" viewBox="0 0 10 12" className="">
            <path
